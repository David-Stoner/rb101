...
array of any substrings which are palindromes
...
1. can there be spaces in the palindrome?



2. do we have to deal with inputs which are not strings?



3. will there be strings with multiple words?
...
take a set of characters
find all sets of consecutive characters within a larger set which are the same backwards and forwards
